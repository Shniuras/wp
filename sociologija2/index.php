        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="about-more">
                    <a href="<?php the_permalink(); ?>">Skaityti daugiau
                        <span>>></span>
                    </a>
                </div>
            </div>
...
<section class="team">
    ...
    <div class="container-fluid">
        <div class="team-more">
            <a href="komanda.php">Skaityti daugiau
                <span>>></span>
            </a>
        </div>
    </div>
...
<section class="events">
    ...
    <div class="events-more">
        <a href="<?php echo get_stylesheet_directory_uri(); ?>/renginiai.php">Skaityti daugiau</a>
        <span>>></span>
    </div>
    </div>
    </div>
...
<section class="gallery">
    <div class="container">
        ...
        <div class="gallery-more">
            <a href="<?php echo get_stylesheet_directory_uri(); ?>/galerija.php">Žiūrėti daugiau</a>
            <span>>></span>
        </div>
    </div>
</section>
...
<section class="study">
    <div class="container">
        ...
        <div class="study-more">
            <a href="<?php echo get_stylesheet_directory_uri(); ?>/studijos.php">Skaityti daugiau</a>
            <span>>></span>
        </div>
    </div>
</section>
<section class="blog">
    <div class="container">
        ...
        <div class="blog-more">
            <a href="<?php echo get_stylesheet_directory_uri(); ?>/home.php">Skaityti daugiau</a>
            <span>>></span>
        </div>
    </div>
